...
class NavbarLink(private val label: String,
    ...
    private val activeClasses = "block py-2 px-3 text-white bg-primary-700 rounded md:bg-transparent md:text-primary-700 " +
            "md:p-0 dark:text-white md:dark:text-primary-500"

    private val inactiveClasses = "navbar-link block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 " +
            "md:hover:bg-transparent md:border-0 md:hover:text-primary-700 md:p-0 dark:text-white " +
            "md:dark:hover:text-primary-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
