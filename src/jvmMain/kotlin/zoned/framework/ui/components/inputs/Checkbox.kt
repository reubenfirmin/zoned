...
class Checkbox(
    ...
    fun render() {
        ...
        div("w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-primary-300 " +
                "dark:peer-focus:ring-primary-800 dark:bg-gray-700 peer-checked:after:translate-x-full " +
