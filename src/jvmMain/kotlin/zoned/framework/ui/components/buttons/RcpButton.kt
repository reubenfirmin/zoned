...
object ButtonClasses {
    const val primaryClasses = "text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 " +
            "font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 " +
    ...
    const val highlight1Classes = "text-white bg-opacity-100 bg-primary-600 bg-gradient-to-r from-primary-500 via-primary-600 to-primary-700 " +
            "hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-primary-300 " +
            "dark:focus:ring-primary-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
